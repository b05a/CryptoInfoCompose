package com.example.cryptoinfocompose.Services
...
class BotService : Service() {
    var db = RepositoryRoom(MainDb.getDb(this))
    var listCrypto: List<Crypto> = mutableListOf<Crypto>()
    var botVariable : BotVariables = BotVariables()
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        mediaPlayer=MediaPlayer.create(this, R.raw.budinik)
        ...
        messageToChatAndRequest()

        return Service.START_STICKY
    }

    // метод запросов и отправки сообщений в чат
    private fun messageToChatAndRequest() {
        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            while (d != "Выход") {
                ...
                for (i in listCrypto){
                    ...
                    // выполняем условия для ночного режима при условии что цена ниже максимальной цены оповещения
    ...
    override fun onDestroy() {
        ...
        // присваиваем переменной d значение "Выход", тем самым выходя из цикла
        d="Выход"
